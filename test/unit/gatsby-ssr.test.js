...
function setup() {
  ...
  const SmarterTrackLiveChatScript = td.replace(
    "../../src/smartertrack-live-chat-script"
  );
  const SmarterTrackLiveChatHtml = td.replace(
    "../../src/smartertrack-live-chat-html"
  );
  const SmarterTrackWhosOnScript = td.replace(
    "../../src/smartertrack-whos-on-script"
  );
...
test("gatsby-ssr.js", t => {
  ...
  t.test("onRenderBody", assert => {
    ...
    const message =
      "should NOT invoke 1st arg fn, when 2nd arg obj contains falsey property: fqdn";
    const expected = undefined;
  ...
  t.test("onRenderBody", assert => {
    ...
    const message =
      "should invoke 1st arg fn, when 2nd arg obj contains truthy property: fqdn";
    const expected = undefined;
  ...
  t.test("onRenderBody", assert => {
    ...
    const message =
      "should invoke 1st arg fn arg [SmarterTrackWhosOnScript], when 2nd arg obj contains truthy property: fqdn and liveChat.isEnabled = false";
    const expected = undefined;
  ...
  t.test("onRenderBody", assert => {
    ...
    const message =
      "should invoke 1st arg fn args [SmarterTrackLiveChatHtml,SmarterTrackLiveChatScript], when 2nd arg obj contains truthy property: fqdn and whosOn.isEnabled = false";
    const expected = undefined;
  ...
  t.test("onPreRenderHTML", assert => {
    ...
    const message =
      "should move objects with who's on (script and tag keys) to last positions in array";
    const expected = undefined;
